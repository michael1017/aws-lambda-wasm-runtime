    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to AWS Lambda <a href="https://docs.aws.amazon.com/lambda/latest/dg/lambda-python.html">Python!</a>
        </h1>
        ...
        <div className={styles.operating}>
          <div>
            ...
            <button id="runBtn" onClick={runWasm} disabled={!enableWasm || loading}>{loading ? 'Loading' : 'Classify with AWS Lambda'}</button>
          </div>
